...
(function (root, factory) {
  ...
  var _STYLE_OVERRIDES = {
    ...
    entrance_marker: { fill_mode: "solid", fill_color: "#E08020" },
    fire_route_line: {
      stroke_color: "#E08020",
      stroke_width: 0.008,
      end_arrow: true,
    ...
    facility_zone: { fill_mode: "translucent" },
    trash_collection_point: {
      fill_mode: "solid",
      fill_color: "#DCE8C8",
    },
    sponge_zone: { fill_mode: "translucent" },
    ecological_ditch_line: {
      stroke_color: "#7AA35A",
      stroke_style: "dashed",
    },
    runoff_line: { stroke_color: "#3070D0", end_arrow: true },
