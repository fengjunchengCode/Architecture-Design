...
def run_checks() -> list[Check]:
    checks = [
        ...
        check_file("_tools/amap_context.py"),
        check_file("_tools/dwg_probe.py"),
        check_file("_tools/cad_preview.py"),
        check_file("_tools/cad_semantics.py"),
        check_file("_tools/cad_align.py"),
        ...
        check_file("skills/_shared/development_contract.md"),
    ...
    checks.extend(
        [
            ...
            check_compile("_tools/amap_context.py"),
            check_compile("_tools/dwg_probe.py"),
            check_compile("_tools/cad_preview.py"),
            check_compile("_tools/cad_semantics.py"),
            check_compile("_tools/cad_align.py"),
